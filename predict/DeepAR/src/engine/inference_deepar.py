...
from data.dataset_deepar import build_multi_item_dataset, lag_features_by_1day
from shared.utils.unified_output import build_forecast_payload, write_json
...
def _resolve_output_root(
    ...
    return (
        Path("outputs/predictions/unified/deepar")
        / commodity
        / exp_name
        / f"fold_{fold}"
        / "results"
