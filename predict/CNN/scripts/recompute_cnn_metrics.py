...
from data.dataset_cnn import CNNDataset
from metrics.metrics_cnn import compute_metrics_per_horizon, summarize_metrics
...
def main() -> None:
    ...
    root = Path("outputs/predictions/cnn") / args.commodity
    if not root.exists():
