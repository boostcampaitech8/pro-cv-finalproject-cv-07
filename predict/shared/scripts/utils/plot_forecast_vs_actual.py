...
python scripts/plot_forecast_vs_actual.py \
  --predictions outputs/predictions/corn_2025-10-02_tft_eval/tft_predictions.csv \
  --data_dir shared/src/datasets/local_bq_like/corn \
  --window 20 \
  --history_days 60 \
  --output_path outputs/predictions/corn_2025-10-02_tft_eval/plots/actual_vs_pred.png
"""
