...
crawler_config.py 에서 키워드 확인 후에 수집 시작하기
"""
...
# 경로 설정
NEWS_PREPROCESS_ROOT = Path(__file__).resolve().parent
PYTHON_ROOT = NEWS_PREPROCESS_ROOT.parent
...
from engines.status_judge import unload_model
