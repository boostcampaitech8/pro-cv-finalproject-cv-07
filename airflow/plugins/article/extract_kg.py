...
import sys
_ARTICLE_DIR = Path(__file__).resolve().parent       # plugins/article/
_AIRFLOW_ROOT = _ARTICLE_DIR.parent.parent           # airflow/
_REPO_ROOT = _AIRFLOW_ROOT.parent                    # pro-cv-finalproject-cv-07/

sys.path.insert(0, str(_ARTICLE_DIR))
from status_judge import _get_client, DEFAULT_MODEL
